...
type CommonStrings struct {
	...
	TeamName string // signature team name, e.g. "The Mail Studio Team"
}
...
var englishTranslations = Translations{
	...
	Common: CommonStrings{
		Greeting: "Hello,",
		TeamName: "The Mail Studio Team",
	},
	MagicCode: MagicCodeStrings{
		Subject:      "Your Mail Studio authentication code",
		Heading:      "Your authentication code",
		Intro:        "Your authentication code for Mail Studio is:",
		Expiry:       "The code will expire in 10 minutes.",
		IgnoreNotice: "If you did not request this code, please ignore this email.",
		SignOff:      "Thanks,",
	},
	Invitation: InvitationStrings{
		Subject:     "You've been invited to join %s on Mail Studio",
		Heading:     "You've been invited to join Mail Studio!",
		Body:        "%[1]s has invited you to join the %[2]s workspace on Mail Studio.",
...
var frenchTranslations = Translations{
	...
	Common: CommonStrings{
		Greeting: "Bonjour,",
		TeamName: "L'équipe Mail Studio",
	},
	MagicCode: MagicCodeStrings{
		Subject:      "Votre code d'authentification Mail Studio",
		Heading:      "Votre code d'authentification",
		Intro:        "Votre code d'authentification pour Mail Studio est :",
		Expiry:       "Ce code expirera dans 10 minutes.",
		IgnoreNotice: "Si vous n'avez pas demandé ce code, veuillez ignorer cet e-mail.",
		SignOff:      "Merci,",
	},
	Invitation: InvitationStrings{
		Subject:     "Vous avez été invité à rejoindre %s sur Mail Studio",
		Heading:     "Vous avez été invité à rejoindre Mail Studio !",
		Body:        "%[1]s vous a invité à rejoindre l'espace de travail %[2]s sur Mail Studio.",
...
var spanishTranslations = Translations{
	...
	Common: CommonStrings{
		Greeting: "Hola,",
		TeamName: "El equipo de Mail Studio",
	},
	MagicCode: MagicCodeStrings{
		Subject:      "Tu código de autenticación de Mail Studio",
		Heading:      "Tu código de autenticación",
		Intro:        "Tu código de autenticación para Mail Studio es:",
		Expiry:       "El código caducará en 10 minutos.",
		IgnoreNotice: "Si no solicitaste este código, ignora este correo electrónico.",
		SignOff:      "Gracias,",
	},
	Invitation: InvitationStrings{
		Subject:     "Te han invitado a unirte a %s en Mail Studio",
		Heading:     "¡Te han invitado a unirte a Mail Studio!",
		Body:        "%[1]s te ha invitado a unirte al espacio de trabajo %[2]s en Mail Studio.",
...
var germanTranslations = Translations{
	...
	Common: CommonStrings{
		Greeting: "Hallo,",
		TeamName: "Das Mail Studio-Team",
	},
	MagicCode: MagicCodeStrings{
		Subject:      "Ihr Mail Studio-Authentifizierungscode",
		Heading:      "Ihr Authentifizierungscode",
		Intro:        "Ihr Authentifizierungscode für Mail Studio lautet:",
	...
	Invitation: InvitationStrings{
		Subject:     "Sie wurden eingeladen, %s auf Mail Studio beizutreten",
		Heading:     "Sie wurden zu Mail Studio eingeladen!",
		Body:        "%[1]s hat Sie eingeladen, dem Workspace %[2]s auf Mail Studio beizutreten.",
...
var catalanTranslations = Translations{
	...
	Common: CommonStrings{
		Greeting: "Hola,",
		TeamName: "L'equip de Mail Studio",
	},
	MagicCode: MagicCodeStrings{
		Subject:      "El teu codi d'autenticació de Mail Studio",
		Heading:      "El teu codi d'autenticació",
		Intro:        "El teu codi d'autenticació per a Mail Studio és:",
		Expiry:       "El codi caducarà en 10 minuts.",
		IgnoreNotice: "Si no has sol·licitat aquest codi, ignora aquest correu electrònic.",
		SignOff:      "Gràcies,",
	},
	Invitation: InvitationStrings{
		Subject:     "T'han convidat a unir-te a %s a Mail Studio",
		Heading:     "T'han convidat a unir-te a Mail Studio!",
		Body:        "%[1]s t'ha convidat a unir-te a l'espai de treball %[2]s a Mail Studio.",
...
var portugueseBRTranslations = Translations{
	...
	Common: CommonStrings{
		Greeting: "Olá,",
		TeamName: "A equipe da Mail Studio",
	},
	MagicCode: MagicCodeStrings{
		Subject:      "Seu código de autenticação da Mail Studio",
		Heading:      "Seu código de autenticação",
		Intro:        "Seu código de autenticação para a Mail Studio é:",
		Expiry:       "O código expirará em 10 minutos.",
		IgnoreNotice: "Se você não solicitou este código, ignore este e-mail.",
		SignOff:      "Obrigado,",
	},
	Invitation: InvitationStrings{
		Subject:     "Você foi convidado para participar de %s na Mail Studio",
		Heading:     "Você foi convidado para participar da Mail Studio!",
		Body:        "%[1]s convidou você para participar do espaço de trabalho %[2]s na Mail Studio.",
...
var japaneseTranslations = Translations{
	...
	Common: CommonStrings{
		Greeting: "こんにちは、",
		TeamName: "Mail Studio チーム",
	},
	MagicCode: MagicCodeStrings{
		Subject:      "Mail Studio 認証コード",
		Heading:      "認証コード",
		Intro:        "Mail Studio の認証コードは次のとおりです:",
		Expiry:       "このコードは10分後に有効期限が切れます。",
		IgnoreNotice: "このコードをリクエストしていない場合は、このメールを無視してください。",
		SignOff:      "よろしくお願いいたします、",
	},
	Invitation: InvitationStrings{
		Subject:     "%s に参加するよう招待されました（Mail Studio）",
		Heading:     "Mail Studio への参加に招待されました！",
		Body:        "%[1]s さんが、Mail Studio のワークスペース %[2]s への参加にあなたを招待しました。",
...
var italianTranslations = Translations{
	...
	Common: CommonStrings{
		Greeting: "Ciao,",
		TeamName: "Il team di Mail Studio",
	},
	MagicCode: MagicCodeStrings{
		Subject:      "Il tuo codice di autenticazione Mail Studio",
		Heading:      "Il tuo codice di autenticazione",
		Intro:        "Il tuo codice di autenticazione per Mail Studio è:",
		Expiry:       "Il codice scadrà tra 10 minuti.",
		IgnoreNotice: "Se non hai richiesto questo codice, ignora questa email.",
		SignOff:      "Grazie,",
	},
	Invitation: InvitationStrings{
		Subject:     "Sei stato invitato a unirti a %s su Mail Studio",
		Heading:     "Sei stato invitato a unirti a Mail Studio!",
		Body:        "%[1]s ti ha invitato a unirti allo spazio di lavoro %[2]s su Mail Studio.",
